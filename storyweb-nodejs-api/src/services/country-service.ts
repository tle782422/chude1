...
export const saveCountry = async (country: any) => {
    return await db.one('INSERT INTO Country(id, capital, code, continent, description, nationality) ' +
        'VALUES ($1, $2, $3, $4, $5, $6)',
        [country.id, country.capital, country.code, country.continent, country.description, country.nationality])
}
